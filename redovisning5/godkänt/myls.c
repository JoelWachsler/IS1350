 ...
 *       Filename:  myls.c
 *
 *    Description:  Skriv ett program som listar innehållet i en mapp och skriver ut namn, typ,
 *                  storlek, inode mm för varje element. Förklara i vilka datastrukturer vi hitar
 *                  vilken information.
 *
 *        Version:  1.0
 *        Created:  2017-03-02 14:09:04
 *       Revision:  none
 *       Compiler:  gcc
 *
